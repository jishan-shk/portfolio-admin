...
{{--                        </svg>--}}
                        <svg width="33px" height="32px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" fill="rgb(255, 255, 255)" d="M21 8L17.4392 9.97822C15.454 11.0811 14.4614 11.6326 13.4102 11.8488C12.4798 12.0401 11.5202 12.0401 10.5898 11.8488C9.53864 11.6326 8.54603 11.0811 6.5608 9.97822L3 8M6.2 19H17.8C18.9201 19 19.4802 19 19.908 18.782C20.2843 18.5903 20.5903 18.2843 20.782 17.908C21 17.4802 21 16.9201 21 15.8V8.2C21 7.0799 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V15.8C3 16.9201 3 17.4802 3.21799 17.908C3.40973 18.2843 3.71569 18.5903 4.09202 18.782C4.51984 19 5.07989 19 6.2 19Z" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                    </div>
                    <div>
                        <h2 class="text-white invoice-num messages"></h2>
                        <span class="text-white fs-18">Messages</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-6 col-xxl-6 col-sm-6">
            <div class="card bg-success invoice-card">
                <div class="card-body d-flex">
                    ...
                    <div>
                        <h2 class="text-white invoice-num experience">-</h2>
                        <span class="text-white fs-18">Experience</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6">
                            <div class="card-bx bg-blue">
                                <img class="pattern-img" src="{{ '/plugins/images/pattern/pattern6.png' }}" alt="">
                                <div class="card-info text-white">
                                    <img src="{{ '/plugins/images/pattern/circle.png' }}" class="mb-4" alt="">
        ...
        <div class="col-xl-3 col-xxl-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="user-bx">
                        <img src="{{ '/plugins/images/profile/small/pic1.jpg' }}" alt="">
                        <div>
                    ...
                    <ul class="user-list">
                        <li><img src="{{ '/plugins/images/avatar/1.jpg' }}" alt=""></li>
                        <li><img src="{{ '/plugins/images/avatar/2.jpg' }}" alt=""></li>
                        <li><img src="{{ '/plugins/images/avatar/3.jpg' }}" alt=""></li>
                        <li><img src="{{ '/plugins/images/avatar/4.jpg' }}" alt=""></li>
                        <li><img src="{{ '/plugins/images/avatar/5.jpg' }}" alt=""></li>
                        <li><img src="{{ '/plugins/images/avatar/6.jpg' }}" alt=""></li>
                    </ul>
                        ...
                        <div class="card-body d-flex">
                            <div class="me-auto">
                                ...
                                <div class="d-flex align-items-center">
                                    <h2 class="fs-38 mb-0 total_projects">0</h2>
            ...
            $.ajax({
                ...
                success: function (response) {
                    if(response.success){
                        ...
                        $('.total_projects').text(data.projects)
