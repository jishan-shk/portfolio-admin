    ...
    <div class="row">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-6">
                            <div class="card-bx bg-blue">
                                <img class="pattern-img" src="{{ asset('plugins/images/pattern/pattern6.png') }}" alt="">
                                <div class="card-info text-white">
                                    <img src="{{ asset('plugins/images/pattern/circle.png') }}" class="mb-4" alt="">
        ...
        <div class="col-xl-3 col-xxl-7">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="user-bx">
                        <img src="{{ asset('plugins/images/profile/small/pic1.jpg') }}" alt="">
                        <div>
                    ...
                    <ul class="user-list">
                        <li><img src="{{ asset('plugins/images/avatar/1.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('plugins/images/avatar/2.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('plugins/images/avatar/3.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('plugins/images/avatar/4.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('plugins/images/avatar/5.jpg') }}" alt=""></li>
                        <li><img src="{{ asset('plugins/images/avatar/6.jpg') }}" alt=""></li>
                    </ul>
